  ...
  return (
    <section className="flex flex-col min-h-screen justify-between p-2 md:p-24 m-auto py-10 md:flex-row lg:flex-row">
      <div className="w-full p-4 md:w-[500px] hidden md:block">
        <IPhoneComponent links={links} /> {/* Pass links as props if needed */}
      </div>
      <div className="w-full p-4 md:w-[60%]">
        <div className="flex flex-col p-8 bg-white rounded-lg shadow-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <div className="mb-4 flex-col md:flex-row gap-4 w-full">
            ...
            <div className="mb-4 flex-col md:flex-row gap-4">
            ...
            <button type="submit" className="px-6 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600">Save</button>
          </form>
        </div>
      </div>
    </section>
